...
void ASTUGameModeBase::StartRespawn(AController* Controller) {
	...
	const auto RespawnComponent = STUUtils::GetSTUPlayerComponent<USTURespawnActorComponent>(Controller);
...
void ASTUGameModeBase::StartRound() {
	...
	GetWorldTimerManager().SetTimer(GameRoundTimeHande, this, &ASTUGameModeBase::GameTimerUpdate, 1.f, true);
}
...
void ASTUGameModeBase::GameTimerUpdate() {
	...
	if (--RoundCountDown == 0) {
		GetWorldTimerManager().ClearTimer(GameRoundTimeHande);
